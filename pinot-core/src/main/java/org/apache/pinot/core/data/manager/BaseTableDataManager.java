...
public abstract class BaseTableDataManager implements TableDataManager {
  ...
  public List<SegmentDataManager> acquireAllSegments(boolean excludeReplacedSegments) {
    ...
    if (segmentLineage == null || !excludeReplacedSegments) {
      ...
      Set<String> segmentsToFilterOut = SegmentLineageUtils.getDuplicateSegmentsToFilterOut(segmentLineage);
      List<SegmentDataManager> filteredSegmentDataManagers = new ArrayList<>();
      for (SegmentDataManager segmentDataManager : segmentDataManagers) {
        if (!segmentsToFilterOut.contains(segmentDataManager.getSegmentName())) {
